...
def load_HDFS(log_file, label_file=None, window='session', train_ratio=0.5, split_type='sequential', save_csv=True, window_size=0):
    ...
    if log_file.endswith('.npz'):
        ...
        for idx, row in struct_log.iterrows():
            blkId_list = re.findall(r"(\d+)", str(row['LineId']))
