...
struct_log_test = '../data/HDFS/syslog1.csv' # The structured log file
struct_log_entreno = '../data/HDFS/syslog2.csv' # The structured log file
...
if __name__ == '__main__':
    ...
    (x_train, _), (_, _) = dataloader.load_HDFS(struct_log_entreno, window='session',split_type='sequential', train_ratio=1)
    print(x_train)
    ...
    dl = pd.DataFrame(y_test)
    dl.to_csv('y.csv', index=True)
    #ignorar
